"""Reads and prints joint angles from Go1 robot without powering them.

By default prints all joint angles. To select specific joints:
`python go1_print_angles.py --joint FR_hip_motor --joint RL_upper_joint`
"""
...
def main(_):
  ...
  robot = go1_robot.Go1Robot(pybullet_client=p, action_repeat=1)
