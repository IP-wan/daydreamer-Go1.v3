"""Simple script for executing random actions on Go1 robot."""
...
FLAGS = flags.FLAGS
flags.DEFINE_enum('robot_type', 'Go1', ['Go1', 'Laikago'], 'Robot Type.')
...
ROBOT_CLASS_MAP = {'Go1': go1.Go1, 'Laikago': laikago.Laikago}
